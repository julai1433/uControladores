...
int main(void)
{
 ...
 HAL_I2C_Master_Transmit(&hi2c1,i,i2cBuf,2,10);
 //Prueba de lectura.................
...
// //leemos el sensor
// 
// HAL_I2C_Master_Transmit(&hi2c1,i,i2cBuf,1,10);
// i2cBuf[1]=0;		//Si hay que borrarla par ver que si tiene un 8, para probar
// HAL_I2C_Master_Receive(&hi2c1,i,&i2cBuf[1],1,100); //en i2cBuf[1] tiene que estar los 8 bits que transmiti 
 ...
 //..................................
  ...
  while (1)
  {
		...
		HAL_I2C_Master_Receive(&hi2c1,i,&i2cBuf[1],6,100); 
		...
		HAL_I2C_Master_Transmit(&hi2c1,i,i2cBuf,1,10);
		HAL_I2C_Master_Receive(&hi2c1,i,&i2cBuf[1],6,10); 
